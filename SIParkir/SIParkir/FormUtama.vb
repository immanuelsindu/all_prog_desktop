...
Public Class FormUtama
    ...
    Private Sub FormUtama_Load(sender As Object, e As KeyEventArgs) Handles MyBase.Load
        Dim sql As String
    ...
    Private Sub Label1_Click(sender As Object, e As EventArgs) Handles lblJenis.Click

    End Sub

    Private Sub Label1_Click_1(sender As Object, e As EventArgs) Handles lblTekan.Click
    ...
    Private Sub Label1_Click_3(sender As Object, e As EventArgs) Handles lblInfoJenis2.Click
